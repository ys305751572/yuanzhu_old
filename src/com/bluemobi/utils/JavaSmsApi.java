...
public class JavaSmsApi {
	...
	private static String API_KEY = "a609ebe9c4ae6ba480f1699fc1b319bc";
	
	private static String TEXT = "【原助APP】您的验证码是：s。请不要把验证码泄露给其他人。";
	// 编码格式。发送编码格式统一用UTF-8
	private static String ENCODING = "UTF-8";
	///【原助】您的验证码是：【391238】。请不要把验证码泄露给其他人。
...
//		String mobile = "13476107753";
	...
	public static String sendSms(String text, String mobile) throws IOException {
		...
		params.put("text", TEXT.replace("s", text));
