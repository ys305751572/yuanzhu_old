 ...
 */
@Service
public class GrouptypeServiceImpl extends BaseService {

    public static String PREFIX = Grouptype.class.getName();

    public Page<List<Grouptype>> list(Map<String, Object> params, int current, int pagesize) {
    ...
    public Grouptype getById(Map<String, Object> params) throws Exception {
