 ...
 */
@Service
public class ActtypeServiceImpl extends BaseService {

    public static String PREFIX = Acttype.class.getName();

    public Page<List<Acttype>> list(Map<String, Object> params, int current, int pagesize) {
    ...
    public Acttype getById(Map<String, Object> params) throws Exception {
