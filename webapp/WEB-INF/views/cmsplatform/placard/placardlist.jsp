							...
							columns : [ [
									...
									},
									{
										...
										formatter : function(value, row, index) {
											...
											return '<img src="images/view-flag.png" title="查看" width="20px" style="cursor:pointer;" height="20px" onclick="showplacard('
													+ id
													+ ')">&nbsp;&nbsp;<img src="images/edt.gif" title="编辑" width="20px" style="cursor:pointer;" height="20px" onclick="updateplacard('
													+ id
													+ ')">&nbsp;&nbsp;<img src="images/role.png" title="查看" width="20px" style="cursor:pointer;" height="20px" onclick="showplacardRecord('
													+ id
													+ ')">';
										}
									} ] ],
