	    ...
	    <form id="detail" name="detail" method="post" enctype="multipart/form-data">
	    	 <table class="ttab" height="400px" width="80%" border="0"
            	...
            	<tr>
					...
					<td style="text-align: right; width: 15%;height: 30px">商品名称<span style="color: red;">*</span>：</td>
					<td colspan="2">
						<input id="name" name="name" style="height: 20px;width: 200px" class="textbox" type="text" >
					</td>
				</tr>
				<tr>
					<td style="text-align: right; width: 15%;height: 30px"">爱佑币数量<span style="color: red;">*</span>：</td>
					<td colspan="2">
						<input id="coin" name="coin" style="height: 20px;width: 200px" class="textbox" type="text">
					</td>
				</tr>
				<tr>
					<td style="text-align: right; width: 15%;height: 280px">商品图片：</td>
					<td colspan="2">
						<img id="imgs" src="" width="180px;" height="250px;"/><br/>
						<input id="pic" name="pic" style="height: 20px;width: 200px" class="textbox" type="file">
						<span id="deletebtn" class='input_btn_style1' onclick="deletepic()">删除图片</span>
					</td>
				</tr>
                <tr>
                ...
                <tr>
					<td colspan="4" style="padding: 10px">
						<div align="center">
							<input type="button" value="　提　交　" class="input_btn_style1" id="dosubmit"> &nbsp;&nbsp;&nbsp;&nbsp; 
