	    ...
	    <form id="detail" name="detail" method="post" enctype="multipart/form-data">
	    	 <table class="ttab" height="400px" width="80%" border="0"
            	...
            	<tr>
					...
					<td colspan="2">
						<input id="name" name="name" style="height: 20px;width: 200px" class="textbox" type="text" value="${gift.name }">
					</td>
				</tr>
				<tr>
					<td style="text-align: right; width: 15%;height: 30px"">爱佑币数量<span style="color: red;">*</span>：</td>
					<td colspan="2">
						<input id="coin" name="coin" style="height: 20px;width: 200px" class="textbox" type="text" value="${gift.coin}">
					</td>
				</tr>
				<tr>
