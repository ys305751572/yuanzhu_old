...
<script type="text/javascript">
							...
							columns : [ [
									...
									},
									{
										...
										formatter : function(value, row, index) {
											...
											console.log("groupid:" + groupid + "==groupidStr:" + groupidStr)
										return "<img src='images/view-flag.png' title='查看' width='20px' style='cursor:pointer;' height='20px' onclick=groupShow('" + groupidStr + "')>";
										}
									} ] ],
							toolbar : '#toolbar_t',
	...
	function groupShow(index) {
		...
		window.location.href = global_ctxPath + '/groupShow?id=' + index + '&pageNumber=1';
	}
